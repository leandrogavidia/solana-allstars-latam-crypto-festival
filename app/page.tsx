...
export default function Home() {
  ...
  // const bgImage = isGif ? "bg-custom-image-gif" : "bg-custom-image";
  ...
  return (
    <section>
      <div
        className={
          "w-full h-auto min-h-[440px] flex justify-center text-center items-center flex-col gap-y-5 p-10 mt-[92px] bg-custom-image"
        }
      >
        <p className="font-semibold z-30 ">
          Caracas, Venezuela • 24 de Noviembre, 2024
        </p>
        <h1 className="text-4xl font-bold z-30 ">
          Solana Allstars LATAM Crypto Festival
        </h1>
      ...
      <div className="flex justify-center items-center gap-x-8 mt-10 px-5 mb-32">
        {extraInfoList.map((info) => (
          <div
            key={info}
            className="text-center bg-white rounded-full text-black w-full h-16 flex justify-center items-center font-semibold"
          >
            <p>{info}</p>
          </div>
        ))}
      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2 justify-center items-center px-5">
        <div className="flex flex-col justify-center items-start gap-y-7">
          <h2 className="text-3xl text-secondary font-semibold">
            Sobre LATAM Crypto Festival
          </h2>
          <p>
            ¡Únete al Latam Crypto Festival en Caracas, Venezuela! Este evento
            de un día, organizado por el equipo de Solana Allstars, está
            dedicado a impulsar la adopción de la blockchain de Solana en
            América Latina.{" "}
          </p>
          <p>
            Descubre las últimas innovaciones, participa en talleres
            interactivos y conecta con líderes de la industria. No te pierdas
            esta oportunidad única de formar parte del futuro del blockchain.
