export default function Agenda() {
    ...
    return (
        <section className="mt-[140px] px-5">
            <h1 className="text-3xl font-bold mt-16]"><span className="text-[#00f8b7]">Agenda:</span> 31 de Agosto, 2024</h1>

            <div className="flex flex-col justify-center items-center gap-y-10 mt-16">
                {
